...
public class EntityPoisonPool : EntityEnviroment
{
    ...
    public void SetUpPoisonPoolWLifeTime(GameObject _owner, float _damageTick, float _lifetime, Vector3 _pos, bool _isStatic = true)
    {
        ...
        ParticleSystem ps = ParticleHandler.GetInstance().SpawnParticle(ParticleHandler.ParticleType.PoisonCloud, null, _pos, Quaternion.identity.eulerAngles, _lifetime).GetComponent<ParticleSystem>();
